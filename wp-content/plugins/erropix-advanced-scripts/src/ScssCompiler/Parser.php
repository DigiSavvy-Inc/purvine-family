    ...
    protected function parseChunk()
    {
        ...
        if (isset($this->buffer[$this->count]) && $this->buffer[$this->count] === '@') {
            ...
            if (
                ...
                $this->logger->warn("The \"@scssphp-import-once\" directive is deprecated and will be removed in SCSS 2.0, in \"$file\", line $line, column $column.", true);
                ...
                while ($p !== false && $p < $endCommentCount) {
                    ...
                    if ($this->interpolation($out)) {
                        ...
                        if (!$this->discardComments) {
                            $this->logger->warn("Unterminated interpolations in multiline comments are deprecated and will be removed in SCSS 2.0, in \"$file\", line $line, column $column.", true);
                        }
